class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - Qual desses tem a silhueta mais facil de fazer? " );
    this.question.position(150, 80);
    this.option1.html("1: BOBA " );
    this.option1.position(150, 100);
    this.option2.html("2: CLEBER" );
    this.option2.position(150, 120);
    this.option3.html("3: BATATA DE CARTOLA" );
    this.option3.position(150, 140);
    this.option4.html("4: JORGE" );
